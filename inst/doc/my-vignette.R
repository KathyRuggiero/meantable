...
## ---- echo=FALSE, fig.height=4.5, fig.width=8, fig.align='center', fig.cap = fig.flybplots------------------
ggBoxplot(newfruitfly, y = "Longevity", x = "Partners", facets = c("Type", "."))
...
## ---- fig.height=4.5, fig.width=8, fig.align='center', echo=FALSE, fig.cap=fig.flybpEmbel-------------------
ggBoxplot(newfruitfly, y = "Longevity", x = "Partners", facets = c("Type", "."),
         xLabel = "Number of partners", yLabel = "Lifespan (days)")
...
## ---- fig.height=6, fig.width=8, fig.align='center', fig.show='hide'----------------------------------------
confintplot(fruitfly.tab2, y="Difference", x = "Comparison",
            axisLabelSize = 16, tickMarkLabelSize = 12, xTickLabelAngle = 90)

## ---- echo=FALSE, fig.height=6, fig.width=8, fig.align='center', fig.cap=fig.flyCIplotBase------------------
...
## ---- echo=FALSE, fig.height=6, fig.width=8, fig.align='center', fig.cap=fig.flyCIplotByFactor--------------
...
## ---- echo=FALSE, fig.height=6, fig.width=8, fig.align='center',fig.cap=fig.flyCIplotByPval-----------------
confintplot(fruitfly.tab2, y="Difference", x = "Comparison", facets = c("Control", "."),
            showSignif=TRUE, pvalVar="p", alpha = 0.05,
            axisLabelSize = 16, tickMarkLabelSize = 12, xTickLabelAngle = 90)
